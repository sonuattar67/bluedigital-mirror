      ...
      <div className="container mx-auto px-6">
        ...
        <div className="hidden md:flex items-center justify-center gap-12 lg:gap-16">
          {logos.map((logo, index) => (
            <div
              key={logo.name}
              className="flex items-center justify-center p-4 grayscale hover:grayscale-0 transition-all duration-500 hover:scale-110 animate-fade-in"
        ...
        <div className="md:hidden flex justify-center">
          <div className="flex items-center justify-center p-6 animate-scale-in">
            <img
        ...
        {/* Chat with us button */}
        <div className="flex justify-end mt-8 animate-slide-in-right">
          <div className="flex items-center gap-3 bg-green-50 hover:bg-green-100 transition-all duration-300 rounded-full px-6 py-3 cursor-pointer group hover:scale-105 hover:shadow-medium"
            onClick={() => window.open('https://wa.link/nfvq0t', '_blank')}
          >
